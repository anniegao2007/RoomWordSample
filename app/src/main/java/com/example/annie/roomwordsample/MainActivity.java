...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ViewModelProviders associates ViewModel with UI controller
        myWordViewModel = ViewModelProviders.of(this).get(WordViewModel.class);

        //add observer for LiveData
        myWordViewModel.getAllWords().observe(this, new Observer<List<WordEntity>>() {
            @Override
